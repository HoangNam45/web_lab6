...
public class StudentDAO {
    ...
    // Get number of active students (for dashboard statistics)
    public int getActiveStudents() {
        // Assuming all students in the table are active
        // If you have an 'is_active' column, modify the query accordingly
